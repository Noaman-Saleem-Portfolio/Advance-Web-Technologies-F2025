    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <fieldset className="fieldset bg-base-200 border-base-300 rounded-box  w-full max-w-xl border p-4">
                ...
                <input name="fullName" type="text" className="input w-full" onChange={(e) => handleChange(e)} />

                <label className="label">Email</label>
                <input name="email" type="email" className="input w-full" onChange={(e) => handleChange(e)} />

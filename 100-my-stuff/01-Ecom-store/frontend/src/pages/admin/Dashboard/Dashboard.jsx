        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className="px-4">Nomi's Collection E-Commerce Store</div>
                </nav>
                {/* Page content here */}
                <div className="p-4">
                    <Outlet />
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        {/* List item */}
                        <li>
                            <Link to="/admin/stats" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Stats">
                                {/* Home icon */}
                        ...
                        {/* List item */}
                        <li>
                            <Link to="/admin/inbox" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Inbox">
                                {/* Home icon */}
...
//             {/* MAIN CONTENT */}
//             <div className="drawer-content p-4 bg-base-300 min-h-screen">
//                 {/* Mobile top bar */}
//                 <label
//                     htmlFor="dash-drawer"
...
//                 <label htmlFor="dash-drawer" aria-label="close sidebar" className="drawer-overlay"></label>
...
//     return (
//         <div className="flex p-8 gap-5 bg-base-300 h-screen">
//             <div className="w-[20%] bg-white rounded-box p-2.5">
//                 <Link to={"/admin/stats"} className="flex gap-3.5 hover:bg-base-300 p-3.5">
//                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-gauge-icon lucide-circle-gauge"><path d="M15.6 2.7a10 10 0 1 0 5.7 5.7" /><circle cx="12" cy="12" r="2" /><path d="M13.4 10.6 19 5" /></svg>
//                     <span>Dashboard</span>
//                 </Link>
//                 <Link to={"/admin/users"} className="flex gap-3.5 hover:bg-base-300 p-3.5">
//                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users-round-icon lucide-users-round"><path d="M18 21a8 8 0 0 0-16 0" /><circle cx="10" cy="8" r="5" /><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3" /></svg>
//                     <span>Users</span>
//                 </Link>
//                 <Link to={"/admin/products"} className="flex gap-3.5 hover:bg-base-300 p-3.5">
//                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shopping-basket-icon lucide-shopping-basket"><path d="m15 11-1 9" /><path d="m19 11-4-7" /><path d="M2 11h20" /><path d="m3.5 11 1.6 7.4a2 2 0 0 0 2 1.6h9.8a2 2 0 0 0 2-1.6l1.7-7.4" /><path d="M4.5 15.5h15" /><path d="m5 11 4-7" /><path d="m9 11 1 9" /></svg>
//                     <span>Products</span>
//                 </Link>
//                 <Link to={"/admin/inbox"} className="flex gap-3.5 hover:bg-base-300 p-3.5">
//                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-inbox-icon lucide-inbox"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12" /><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /></svg>
//                     <span>Inbox</span>
//                 </Link>
//             </div>
...
//             <div className="w-[80%] bg-white rounded-box">
//                 <Outlet />
//             </div>
//             {/* right */}
